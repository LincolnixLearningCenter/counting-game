...
sudo service unicorn_CountingGame <start|stop|restart>
sudo service sidekiq_CountingGame <start|stop>
```
...
```
/home/deployer/apps/CountingGame/shared/.env.production
```

After making changes to this file, be sure to restart the application:

```
sudo service unicorn_CountingGame restart
sudo service sidekiq_CountingGame stop
sudo service sidekiq_CountingGame start
```
